"""Tests for the InPost deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.inpost.calendar import InPostDeliveriesCalendar
...
def _cal(data):
    return InPostDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="InPost Shop")])
    assert cal._events()[0].location == "InPost Shop"
