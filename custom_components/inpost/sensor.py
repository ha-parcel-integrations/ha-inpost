"""Sensor platform for the InPost parcel tracker integration."""
...
async def async_setup_entry(
    ...
    """Set up InPost sensor entities from a config entry."""
...
class InPostIncomingParcelsSensor(
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        if new_barcodes:
            self._async_add_entities(
                InPostParcelSensor(self.coordinator, self._entry, barcode)
...
class InPostParcelSensor(CoordinatorEntity[InPostCoordinator], SensorEntity):
    """Per-parcel sensor reporting the status of one tracked InPost parcel."""
    ...
    def __init__(
        self, coordinator: InPostCoordinator, entry: ConfigEntry, barcode: str
    ) -> None:
        super().__init__(coordinator)
        self._entry = entry
...
class InPostNextDeliverySensor(
    CoordinatorEntity[InPostCoordinator], SensorEntity
):
...
class InPostDeliveredParcelsSensor(
    ...
    """Recently delivered tracked InPost parcels."""
...
class InPostLastUpdateSensor(
    CoordinatorEntity[InPostCoordinator], SensorEntity
):
    """Diagnostic sensor reporting when InPost was last polled successfully."""
